...
class Canclescreen extends StatefulWidget {
  ...
  const Canclescreen({super.key, this.isOwner = true});
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, userSnapshot) {
                    if (userSnapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return buildCarCard(car, shopOrUserName, phoneNumber, w, h, formattedStartDate);
                    } else {
            ...
            return Center(child: apptext(myText: "No Cancel Bookings"));
          }
        },
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              if (!widget.isOwner) ...[ // Only show Rebook button if not owner
                SizedBox(
                  height: h * 0.055,
                  width: w * 0.6,
                  child: appbutton(
                    buttonText: "Rebook",
                    onTap: () {}, // Implement rebooking functionality
